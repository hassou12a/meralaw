-- ============================================================
-- SIMPLE SEED: 16 REAL ALGERIAN LAWS
...
('قانون الولاية', 'Loi relative à la wilaya', '12-07', 'إدارة محلية', 2012, 2012, 12,
...
-- 3. Verify
SELECT "referenceNumber", "titleAr", "jorfYear", "jorfNumber", "sourceVerified"
FROM "Law"
